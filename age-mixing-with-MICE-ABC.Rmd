    ...
    only.new = TRUE) 
{
  ...
  shape.nb.male <- as.numeric(fit.negbin$estimate[2])
  scale.nb.male <- as.numeric(fit.negbin$estimate[1]) #(theta = p/(1-p))
...
MICE_ABC_testoutput <- MICE_ABC(targets = target.vector.master, # 15 input parameters in the age-mxing exercise 1.10  0.25  0.00  3.00  0.23  0.23 45.00 45.00 -0.50  2.80 -0.20 -0.20 -2.50 -0.52 -0.05
                                 n.experiments = 128,
