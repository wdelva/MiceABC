...
relations.data.path <- "/Users/delvaw/Documents/MiceABC/Sex Network Master (participant level) 09.08.2012.dta"
    ...
    only.new = TRUE) 
{
  ...
  cfg.list <- input.params.creator(population.eyecap.fraction = 0.2, #0.21,#1,
                                   ...
                                   hivtransmission.param.f2 = log((exp(log(inputvector[2]) * 0.5))^2 / log(inputvector[2])) / 5, #log(log(1.4) / log(2)) / 5,
                                   formation.hazard.agegapry.gap_factor_man_age = -0.01, #-0.01472653928518528523251061,
                                   formation.hazard.agegapry.gap_factor_woman_age = -0.01, #-0.0726539285185285232510561,
                                   formation.hazard.agegapry.meanage = -0.025,
                                   formation.hazard.agegapry.gap_factor_man_const = 0,
  ...
  cfg.list["person.person.eagerness.man.dist.gamma.a"] <- inputvector[6] ######### 3
  cfg.list["person.person.eagerness.woman.dist.gamma.a"] <- inputvector[7] ######### 3
  cfg.list["person.person.eagerness.man.dist.gamma.b"] <- inputvector[8] ######### 3
  cfg.list["person.person.eagerness.woman.dist.gamma.b"] <- inputvector[9] ######### 3
  ...
  cfg["dissolution.alpha_0"] <- input.vector[15]
  cfg["dissolution.alpha_4"] <- input.vector[16]
  ...
  BSD.male <- bvar(men.lmer) # Bad name for the function because it actually extracts between subject standard deviation # BVAD <- ifelse(length(men.lmer) > 0, getVarCov(men.lme)[1,1], bignumber)
  ...
  fit.negbin <- fitdist(degree.vector, "nbinom")
  shape.nb.male <- as.numeric(fit.negbin$estimate[1])
  scale.nb.male <- as.numeric(fit.negbin$estimate[2]) #(theta = p/(1-p))
...
#### Input parameters
1. hivtransmission.param.f1
2. formation.hazard.agegapry.gap_agescale_man = formation.hazard.agegapry.gap_agescale_woman
3. person.agegap.man.dist.normal.mu = person.agegap.woman.dist.normal.mu
4. person.agegap.man.dist.normal.sigma = person.agegap.woman.dist.normal.sigma
5. person.person.eagerness.man.dist.gamma.a
6. person.person.eagerness.woman.dist.gamma.a
7. person.person.eagerness.man.dist.gamma.b
8. person.person.eagerness.woman.dist.gamma.b
9. formation.hazard.agegapry.gap_factor_man_exp = formation.hazard.agegapry.gap_factor_woman_exp
10. formation.hazard.agegapry.baseline
11. formation.hazard.agegapry.numrel_man
12. formation.hazard.agegapry.numrel_woman
13. conception.alpha_base
14. dissolution.alpha_0
15. dissolution.alpha_4
