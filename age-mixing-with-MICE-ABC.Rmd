...
relations.data.path <- "/Users/wimdelva/Documents/MiceABC/Sex Network Master (participant level) 09.08.2012.dta"
    ...
    only.new = TRUE) 
{
  ...
  cfg.list["mortality.aids.survtime.k"] <- -0.2
  #cfg.list["monitoring.cd4.threshold"] <- 0
  cfg.list["person.agegap.man.dist.normal.mu"] <- inputvector[3] # 0
  cfg.list["person.agegap.woman.dist.normal.mu"] <- inputvector[3] # 0
  cfg.list["person.agegap.man.dist.normal.sigma"] <- inputvector[4] ######### 3
  cfg.list["person.agegap.woman.dist.normal.sigma"] <- inputvector[4] ######### 3
  ...
  #cfg["person.agegap.man.dist.fixed.value"] <- -2 # inputvector[2]
  #cfg["person.agegap.woman.dist.fixed.value"] <- -2 # inputvector[2]
  cfg["formation.hazard.agegapry.gap_factor_man_exp"] <- inputvector[5] ######### -0.5
  cfg["formation.hazard.agegapry.gap_factor_woman_exp"] <- inputvector[5] ######### -0.5
  ...
  shape.nb <- as.numeric(fit.negbin$estimate[1])
  scale.nb <- as.numeric(fit.negbin$estimate[2]) #(theta = p/(1-p))
  
  # Concurrency point prevalence 6 months before a survey, among men
  pp.cp.6months.men <- concurr.pointprev.calculator(datalist = datalist.agemix,
