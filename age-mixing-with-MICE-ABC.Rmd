...
load(file = paste0(root.path, "/MiceABC/mice.age-mixing.0.4.RData")) # This loads the object MICE_ABC_testoutput.3
...
MICE_ABC.incremental <- function(targets.empirical = targets.empirical,
                                 ...
                                 RMSD.tol.max = 2, # Initially a wide tolerance range, which then gradually shrinks, once the intermediate targets have converged with the empirical targets
                                 min.givetomice = 128,
                                 n.experiments = 512,
