...
agemix.simulate <- function(param.set, parameter.names = c("age.gap.tol.intercept", "age.gap.tol.coef"), no.repeated.sim=2, nl.obj="agemix.nl1") {#, trace.progress, iter.length, function.name) {
