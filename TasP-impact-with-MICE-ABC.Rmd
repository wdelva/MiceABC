...
load(file = "/Users/delvaw/Documents/MiceABC/incidence.rel.reduc.RData")
```
...
```{r save.calibration.results}
save(MICE_ABC_testoutput, file = "/Users/delvaw/Documents/MiceABC/mice.tasp.RData")

```
Now let's explore and visualise the results
```{r vis.calib.results}
names(MICE_ABC_testoutput)
